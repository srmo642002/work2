	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="create"><g:message code="محصول جدید" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="edit-product" class="content scaffold-edit" role="main">
			<h1><g:message code="ویرایش محصول" args="[entityName]" /></h1>
			...
			<g:form method="post"  enctype="multipart/form-data">
				...
				<fieldset class="buttons">
					...
					<g:actionSubmit class="delete" action="delete" value="${message(code: 'حذف', default: 'حذف')}" formnovalidate="" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
				</fieldset>
			</g:form>
		</div>
	</body>
